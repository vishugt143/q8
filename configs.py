...
class Config:
    ...
    BOT_TOKEN = getenv("BOT_TOKEN", "8355907525:AAHRe94xojhbL-T4m7leekfHU5v0sxGfXN0")

    # Admin / Owner IDs
    SUDO = list(map(int, getenv(
        "SUDO",
        "7554081592 7487038164 7564050858 5656436152"
    ).split()))
    ...
    # Posts to copy
    POSTS = [
        "https://t.me/forward_hack_lnx/259",
        "https://t.me/forward_hack_lnx/260",
        "https://t.me/forward_hack_lnx/261"
    ]
